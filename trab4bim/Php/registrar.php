      ...
      <div class="card login-card">
        <div class="row no-gutters">
            ...
            <div class="brand-wrapper">
               ...
               <div class="btn btn-block login-btn mb-4"><a class="botao"  href="registraCarro.php">Novo Carro</a></div><br>
               <div class="btn btn-block login-btn mb-4"><a class="botao"  href="registraConvenio.php">Novo Convênio</a></div>
</div>
          </div>
        </div>
      </div>
